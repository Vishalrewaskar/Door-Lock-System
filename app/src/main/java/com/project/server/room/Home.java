...
public class Home extends AppCompatActivity
    ...
    private static final int REQUEST_BT_CONNECT = 101;
    ...
    /**
     * Checks for the runtime BLUETOOTH_CONNECT permission (required on Android 12 / API 31+).
     * If granted, enables Bluetooth immediately. If not, requests it from the user and
     * defers the enable() call to onRequestPermissionsResult().
     */
    private void checkBluetoothPermissionAndEnable() {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == REQUEST_BT_CONNECT) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this,
                        "Bluetooth permission is required for this app to connect to the lock.",
